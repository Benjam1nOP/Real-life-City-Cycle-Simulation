...
void DrawGrassField(){
    ...
    for(int i=0;i<4;i++){
        ...
        glEnd();
        glColor3f(0, 153, 0);   
        draw_circle(50+treeDistance,100,20);     
        draw_circle(80+treeDistance,100,20);     
        draw_circle(58+treeDistance,130,18);     
        draw_circle(72+treeDistance,130,18);     
        draw_circle(65+treeDistance,150,14);    
    ...
    for(int i=0;i<4;i++){
        ...
        glEnd();
        glColor3f(0, 153, 0);   
        draw_circle(50+treeDistance,170,20);     
        draw_circle(80+treeDistance,170,20);     
        draw_circle(58+treeDistance,200,18);     
        draw_circle(72+treeDistance,200,18);     
        draw_circle(65+treeDistance,220,14);     
        treeDistance=treeDistance+200;
    }
}
void DrawCloud(){
...
void DrawIndustry(){
    ...
    glEnd();
    glColor3f(0,153,0);   
    draw_circle(500,490,20);     
    draw_circle(530,490,20);     
    draw_circle(508,510,18);     
    draw_circle(522,510,18);     
    draw_circle(515,535,14);     
    glEnd();
    }
}
void DrawDMP(){
...
void DrawCity()
{
    ...
    glEnd();
    glColor3f(0, 153, 0);   
    draw_circle(300,490,20);     
    draw_circle(330,490,20);    
    draw_circle(308,510,18);   
    draw_circle(322,510,18);     
    draw_circle(315,535,14);  
    glBegin(GL_POLYGON);
    glColor3ub(112, 51, 0);  
    glVertex2i(600,420);
    glVertex2i(610,420);
    ...
    glEnd();
    glColor3f(0, 153, 0);   
    draw_circle(590,490,20);   
    draw_circle(620,490,20);     
    draw_circle(598,510,18);     
    draw_circle(612,510,18);     
    draw_circle(605,535,14);      
    DrawIndustry();
    DrawCloud();
    DrawDMP();
    glBegin(GL_POLYGON);
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow ("Real-life City Cycle Simulation" );
    glutDisplayFunc(myDisplay);
    glutTimerFunc(25, update, 100); 
